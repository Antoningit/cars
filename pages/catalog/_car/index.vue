  ...
  <div class="car-card">
    <div class="row">
      ...
      <div class="car-card__subtitle mt-1">
        ...
        пробег {{ car.mileage }} км, модификация {{ car.mod }} {{ car.engine }}
        {{ car.kpp }}, {{ car.drive }} привод, цвет {{ car.color }}, ПТС
        {{ car.pts }}
      </div>
        ...
        <div class="card-content__info info">
            ...
            <div class="content-info__specifications specifications-text">
              ...
              <div class="specifications-text__modification modification">
                ...
                <div class="modification__text modification-text">
                  ...
                  <div class="modification-text__description">Год выпуска</div>
                </div>
              </div>
              <div class="specifications-text__modification modification">
                <div class="modification__icon">
          ...
          <div class="info__advantages content-advantages">
            ...
            <div class="content-advantages__grid-content grid-content">
              ...
              <div class="grid-content__text">
                <div class="grid-content__title">Предпродажная подготовка</div>
                <div class="grid-content__description">
      ...
      <div class="car-card__other card-other">
        <div class="card-other__title" v-if="otherCars.length > 0">
          Другие автомобили {{ car.title }}
        </div>
...
<script>
import { getCar, ButtonCases } from "../../../constants";
...
export default {
  ...
  created() {
    this.car = getCar(Number(this.$route.params.car));
  },
  computed: {
    creditBtnName() {
      const i = 8.5 / 12 / 100;
